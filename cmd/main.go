...
import (
	...
	"github.com/jjsiv/logging-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(jjsiviov1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "d299d18d.jjsiv.io",
	...
	if err := (&controller.LoggingPipelineReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "LoggingPipeline")
		os.Exit(1)
	}
	if err := (&controller.FluentBitReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
